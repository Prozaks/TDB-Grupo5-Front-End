echo 'INSTALADOR TBD-USACH v1.0 by hek23'
cd
sudo apt-get update
...
sudo apt-get -y install php7.0-cgi php7.0-mysql
...
sudo chown -R $USER /usr/local
cd ~
wget http://www-us.apache.org/dist/lucene/java/6.4.2/lucene-6.4.2.zip
unzip lucene-6.4.2.zip
rm lucene-6.4.2.zip
cd ~/lucene-6.4.2/core
mv lucene-core-6.4.2.jar /usr/local/glassfish4/glassfish/lib/lucene-core-6.4.2.jar
cd ~
rm -rf lucene-6.4.2
